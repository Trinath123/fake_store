                    ...
                    <View style={{width: '100%'}}>
                        {this.items.map((item, key) => (
                            <View style={{
                                ...
                                paddingTop: 10,
                                paddingBottom: 10,
                                backgroundColor: this.getActiveRouteState(item.screenToNavigate) ? '#F7F7F7' : Color.white,
                            }} key={key}>
                                <View style={{marginRight: 15, marginLeft: 20}}>
                                    <Icon
                                        name={item.navOptionThumb}
                                        size={22}
                                        color={this.getActiveRouteState(item.screenToNavigate) ? Color.colorPrimary : '#808080'}
                                    />
                                </View>
                                <Text style={{
                                    fontSize: 15,
                                    color: this.getActiveRouteState(item.screenToNavigate) ? Color.colorPrimary : 'black',
                                }}
                                      onPress={() => {
